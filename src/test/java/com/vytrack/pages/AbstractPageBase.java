...
public abstract class AbstractPageBase {
    ...
    /**
     * this method can be used to wait until terrible loader mask ()spinning wheel) will be gone
     * if loader mask is present, website is loading same data and you cannot perform any operation
     */
